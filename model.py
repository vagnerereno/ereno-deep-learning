...
def model(X_train, y_train, X_test):
    ...
    model.compile(loss='mse', optimizer='rmsprop', metrics=['accuracy'], run_eagerly=False)
    ...
    history = model.fit(X_train, y_train, epochs=1, batch_size=32, callbacks=[batch_logger])
